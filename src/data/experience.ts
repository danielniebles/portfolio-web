...
export const experienceData: ExperienceEntry[] = [
  {
    ...
    period: '2024 – Present',
    location: 'Remote',
    description: 'Promoted to Tech Lead after one year — now leading the top-of-funnel experience across 6 brands and 6 countries.',
    highlights: [
      'Part of the team that solved multi-brand monorepo architecture in VTEX — uncharted territory for the platform at the time.',
      'Navigated the integration of a design system token architecture into Faststore components — bridging design and engineering across every brand.',
      'Took the first market live in Colombia: started at an 80/20 traffic split, now running at 100% on the new platform.',
    ],
